...
<a href="https://image-generator.chanmeng-dev.workers.dev/gallery">
  <img src="docs/showcase/gallery.webp" alt="AI Image Generator community gallery — 'Community gallery' headline, search bar for prompts, Latest grid showing 4 AI-generated images: anime figure in autumn coat, premium food advertisement, Chinese moonlit mountain landscape, and photorealistic red apple on black background" width="100%">
</a>

![Demo: AI Image Generator walk-through — login page with GitHub and Google OAuth options and email sign-in form, then transition to the public community gallery showing 13 community-generated images with anime, food, landscape, and product photography styles](docs/showcase/demo.gif)

<details>
<summary>🔐 Sign-in page</summary>

<img src="docs/showcase/login.webp" width="100%" alt="AI Image Generator sign-in — 'Welcome back / Sign in to keep generating.' card with GitHub OAuth, Google OAuth, and email + password form fields, plus Sign up link">

</details>

<details>
<summary>📱 Mobile gallery</summary>

<img src="docs/showcase/mobile-gallery.webp" width="390" alt="AI Image Generator on mobile — community gallery headline, search prompts bar, 2-column image grid showing anime figure and PREMIUM FOOD ad at top, Chinese landscape and red apple below, with download buttons">
